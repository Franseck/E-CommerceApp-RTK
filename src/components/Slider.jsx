...
{sliderData.map((dot,index)=>{
    return (
        <div className="mr-4" key={dot.id}>
          <div
            className={
              index === slideIndex
                ? "bg-blue-gray-900 rounded-full p-2 cursor-pointer"
                : "bg-blue-gray-300 rounded-full p-2 cursor-pointer"
            }
  ...
  <div>
        <button
          className="absolute top-[50%] right-4 bg-blue-gray-300 rounded-full p-2 hover:bg-blue-gray-900"
        ...
        <button
          className="absolute top-[50%] left-4 bg-blue-gray-300 rounded-full p-2 hover:bg-blue-gray-900"
